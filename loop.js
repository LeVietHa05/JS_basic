...
let sum = 0;
let mu = 0;
for (let i = 1; i < 10; i++) {  //ham tram
    for ( let j =0; j < 10; j++) {  //hang chuc
        for (let z = 0; z < 10; z ++){  //hang don vi
            sum = i*100 + j * 10 + z;
...
console.log(lockitu('zse5xdrcyfvtgbhinjmko,yetjykjehrwyueirtluj.hxgfdhsghrtykulj'));