...
const isEven3 = (x) => x % 2 === 0; //ngầm hiểu là có return, chỉ được có một dòng code duy nhất
...
const testString = ["awfjbnsjaojogjaow", "jsavf", "asjf2123asc",'asfsa','q1raacasvasasf'];
/**
 * @param {array} x
 * @returns array of element that have less than 10 letters
 */
const validUserNames = (x) => x.filter((strings) => strings.length < 10).forEach(x => console.log(x));
